...
subscribe_topic="runMES/lot_bin_srv"
srv_name='mq_lot_bin_srv'
...
def on_message(client,userdata,msg):
  ...
  try:
    ...
    op=d['OP_TXT']
    anno=d['ANNO_TXT']
    log_EAP_IF.to_debug({'MQTT':srv_name,'STATUS':'on-message','TID':tid,'RTN':rtn,'LOT':lot,'EQ':eq,'BIN':binning,'GRADE_SET':grade,'OP':op,'ANNO':anno})
