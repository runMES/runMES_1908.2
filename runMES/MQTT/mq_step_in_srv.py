...
subscribe_topic="runMES/step_in_srv"
srv_name='mq_step_in_srv'
...
def on_message(client,userdata,msg):
  ...
  try:
    ...
    log_EAP_IF.to_debug({'MQTT':srv_name,'STATUS':'on_message','payload bytes decode':payload})
    ...
    # step_in(lot_txt,eq_txt,op_txt,anno_txt)
