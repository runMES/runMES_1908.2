...
subscribe_topic="runMES/step_out_srv"
srv_name='mq_step_out_srv'
...
def on_message(client,userdata,msg):
  ...
  try:
    ...
    op=d['OP_TXT']
    anno=d['ANNO_TXT']
    log_EAP_IF.to_debug({'MQTT':srv_name,'STATUS':'on_message','TID_TXT':tid,'RTN_TXT':rtn,'LOT_TXT':lot,'EQ_TXT':eq,'OP_TXT':op})
