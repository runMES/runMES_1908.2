...
subscribe_topic="runMES/eq_record_srv"
srv_name='mq_eq_record_srv'
...
def on_connect(client,userdata,flags,rc):
  ...
  #mylog.debug({'MQTT':srv_name,'STATUS':'on_connect','RC':rc,'CLIENT':client,'USERDATA':userdata,'FLAGS':flags})
...
if __name__=='__main__':
  mylog.info('Start mq_eq_record_srv')
  main()
