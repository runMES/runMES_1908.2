...
subscribe_topic="runMES/qry_lot_bin_srv"
srv_name='mq_qry_lot_bin_srv'
...
def on_message(client,userdata,msg):
  ...
  try:
    ...
    #log_EAP_IF.to_debug({'MQTT':srv_name,'STATUS':'on-message','payload bytes decode':payload})
    ...
    eq=d['EQ_TXT']
    op=d['OP_TXT']
    #log_EAP_IF.to_debug({'MQTT':srv_name,'STATUS':'on-message','TID':tid,'RTN':rtn,'LOT':lot,'EQ':eq,'OP':op})

    # qry_lot_bin(lot_txt,eq_txt,op_txt)
